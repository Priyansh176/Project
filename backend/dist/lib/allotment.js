 ...
 */
async function getCoursesCapacity() {
 ...
 */
async function insertEnrollment(rollNo, courseId, status) {
    await query('INSERT INTO ENROLLMENT (STUDENT_Roll_No, COURSE_Course_ID, Status) VALUES (?, ?, ?)', [rollNo, courseId, status]);
}
/**
 ...
 */
export async function runAllotment() {
